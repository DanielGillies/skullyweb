...
if (window.mobilecheck()) {
    ...
    document.getElementById("indexhero").innerHTML =
        '<video autoplay loop class="fillWidth"> <source src="//dg6vcgn2vehm4.cloudfront.net/videos/indexvid.mp4" type="video/mp4"> <source src="//dg6vcgn2vehm4.cloudfront.net/videos/indexvid.webm" type="video/webm"> <source src="http://dg6vcgn2vehm4.cloudfront.net/videos/indexvid.ogv" type="video/ogv"> Your browser does not support the video tag. I suggest you upgrade your browser. </video>'
